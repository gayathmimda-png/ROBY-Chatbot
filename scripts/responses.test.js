...
const webDesignLearnResponses = ['Here is some usefull tips to learn web design faster. <br><br> 01. First of all learn HTML, CSS & JavaScript <br><br> 02. Play with Code at Codeacademy <br><br> 03.Pay Attention to Websites You Love <br><br> 04. Learn about CSS frameworks (Bootstrap, TailWind) <br><br> 05. Learn about JS frameworks (Angular, ReactJS, VeuJS) <br><br>06.Get Comfortable with Responsive web design <br><br> 07.Get Comfortable with SEO <br><br> Refer this link also <br> <a href="https://w3schools.com" target="_blank" class="resource-card">Learn web design from W3 Schools <i class="fa fa-external-link"></i></a>', 'Follow these usefull tips to learn web design within short time period. <br><br> 01. First of all learn HTML, CSS & JavaScript <br><br> 02. Play with Code at Codeacademy <br><br> 03.Pay Attention to Websites You Love <br><br> 04. Learn about CSS frameworks (Bootstrap, TailWind) <br><br> 05. Learn about JS frameworks (Angular, ReactJS, VeuJS) <br><br> 06.Get Comfortable with Responsive web design <br><br> 07.Get Comfortable with SEO <br><br> Refer this link also <br> <a href="https://w3schools.com" target="_blank" class="resource-card">Learn web design from W3 Schools <i class="fa fa-external-link"></i></a>'];
const webDesignCourseResponses = ['Follow these links to learn web design online. <br> <a href="https://w3schools.com" target="_blank" class="resource-card">Learn zero to hero from W3 Schools <i class="fa fa-external-link"></i></a> <br> <a href="https://cutt.ly/jnewRJ5" target="_blank" class="resource-card">Alison free web design course <i class="fa fa-external-link"></i></a> <br> <a href="https://cutt.ly/bnewmNC" target="_blank" class="resource-card">Webflow University <i class="fa fa-external-link"></i></a> <br> <a href="https://cutt.ly/0newuek" target="_blank" class="resource-card">LearnCode.academy YouTube playlist <i class="fa fa-external-link"></i></a> <br> <a href="https://cutt.ly/kned4KU" target="_blank" class="resource-card">Web Design for Beginners - Udemy.com <i class="fa fa-external-link"></i></a>', 'Use these online resourses to learn web design. <br> <a href="https://w3schools.com" target="_blank" class="resource-card">Learn zero to hero from W3 Schools <i class="fa fa-external-link"></i></a> <br> <a href="https://cutt.ly/jnewRJ5" target="_blank" class="resource-card">Alison free web design course <i class="fa fa-external-link"></i></a> <br> <a href="https://cutt.ly/bnewmNC" target="_blank" class="resource-card">Webflow University <i class="fa fa-external-link"></i></a> <br> <a href="https://cutt.ly/0newuek" target="_blank" class="resource-card">LearnCode.academy YouTube playlist <i class="fa fa-external-link"></i></a> <br> <a href="https://cutt.ly/kned4KU" target="_blank" class="resource-card">Web Design for Beginners - Udemy.com <i class="fa fa-external-link"></i></a>'];
const webDesignBecomeResponses = ['Here is some tips about how to become a web designer <br> 01. Understand the role <br> 02. Determine if web design is the right career for you <br> 03. Learn the skills and tools you need on the job <br> 04.Learn the business skills and tools you need for freelancing <br> 05. Find inspiration and connections in the community <br> 06. Take your first step toward becoming a web designer <br><br> Use these links to learn more about how to beacome a web designer <br> <a href="https://cutt.ly/kne5oU4" target="_blank" class="resource-card">How to become a web designer in 2020 <i class="fa fa-external-link"></i></a> <br> <a href="https://cutt.ly/Jne5vAg" target="_blank" class="resource-card">10 Best Steps Guide on How to Become a Web Designer <i class="fa fa-external-link"></i></a>'];
const webDesignMoneyResponses = ['You can earn money as a web designer from following ways <br> 01. Work for a Design Agency <br> 02. Work as an In-House Designer <br> 03. Freelance <br> 04.Start Your Own Agency <br> 05. Start a Design Blog <br> 06. Create a Course <br><br> Use this links to learn more about how to earn money as a web designer <br> <a href="https://cutt.ly/Sne6VyL" target="_blank" class="resource-card">9 Ways to Make Money as a Web Designer <i class="fa fa-external-link"></i></a>'];
...
const webDevelopLearnResponses = ['Here is some usefull tips to learn web design faster. <br><br> 01. Learn the Basics of HTML, CSS, and Javascript <br><br> 02. Get to Know UI and UX <br><br> 03.Learn SQL and PHP <br><br> 04. Learn the Basics of SEO <br><br> 05. Make sure the site is responsive <br><br> Use this link to learn web development free <br> <a href="https://cutt.ly/znrucrI" target="_blank" class="resource-card">Free Web Development Courses by Udemy <i class="fa fa-external-link"></i></a>', 'Follow these usefull tips to learn web design within short time period. <br><br> 01. Learn the Basics of HTML, CSS, and Javascript <br><br> 02. Get to Know UI and UX <br><br> 03.Learn SQL and PHP <br><br> 04. Learn the Basics of SEO <br><br> 05. Make sure the site is responsive <br><br> Use this link to learn web development free <br> <a href="https://cutt.ly/znrucrI" target="_blank" class="resource-card">Free Web Development Courses by Udemy <i class="fa fa-external-link"></i></a>'];
const webDevelopCourseResponses = ['Follow these links to learn web development online. <br> <a href="https://cutt.ly/8nrupJE" target="_blank" class="resource-card">Web Development Courses by Coursera <i class="fa fa-external-link"></i></a> <br> <a href="https://cutt.ly/znrucrI" target="_blank" class="resource-card">Free Web Development Courses by Udemy <i class="fa fa-external-link"></i></a> <br> <a href="https://cutt.ly/cnruDgO" target="_blank" class="resource-card">Learn web development by Mozilla Developer Network <i class="fa fa-external-link"></i></a>', 'Use these online resourses to learn web development. <br> <a href="https://cutt.ly/8nrupJE" target="_blank" class="resource-card">Web Development Courses by Coursera <i class="fa fa-external-link"></i></a> <br> <a href="https://cutt.ly/znrucrI" target="_blank" class="resource-card">Free Web Development Courses by Udemy <i class="fa fa-external-link"></i></a> <br> <a href="https://cutt.ly/cnruDgO" target="_blank" class="resource-card">Learn web development by Mozilla Developer Network <i class="fa fa-external-link"></i></a>'];
...
describe('getBotResponse', () => {
    ...
    // Substring boundary safety test (e.g. history should NOT match hi)
    test('should NOT trigger hi response for "history"', () => {
        const response = getBotResponse('history');
        expect(hiResponses).not.toContain(response);
    });
